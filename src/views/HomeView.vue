  ...
  <div class="home-page">
    ...
    <div class="flex home-open main-layout">
      ...
      <div class="home-txt">
        <h1>'מרכז למידה 'מיקוד</h1>
        <h5>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cumque quae facere doloremque nostrum debitis voluptate? dolorum,
          aperiam eum nemo neque ex ab consectetur!
        </h5>
        <button class="btn">Let`s Start !</button>
      </div>
    </div>
